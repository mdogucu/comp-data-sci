...
Its importance and lack thereof have been discussed in many disciplines including physics [@junk2020], economics [@chang], and psychology [@opensciencecollaboration2015].
...
For instance, despite having Guidelines for Assessment and Instruction in Statistics Education (GAISE) [-@GAISE2016] and Curriculum Guidelines for Undergraduate Programs in Statistical Science (CGUPSS) [-@asacurricula], ASA has not yet written any guidelines specific to data science education.
...
An even larger endeavor can be taken if investigators want to work off on a definition of data science utilizing a systematic literature review.
